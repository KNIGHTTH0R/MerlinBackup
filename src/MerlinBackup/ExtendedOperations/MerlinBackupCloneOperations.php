...
/**
 * MerlinBackupCloneOperations is the default implementation of {@link MerlinBackupCloneOperationsInterface} which
 * provides routine MerlinBackup methods that are commonly used in the framework.
 *
 * {@link MerlinBackupCloneOperations} is a trait method implimentation requirement used in this framework.
 ...
 *
 * MerlinBackupCloneOperations provides a common set of implementations where needed. The MerlinBackupCloneOperations
 * trait and the MerlinBackupCloneOperationsInterface should be paired together.
 *
 * @author Daryl Eisner <deisner@ucsd.edu>
 */
trait MerlinBackupCloneOperations
{
    /**
     * Properties.
     */
