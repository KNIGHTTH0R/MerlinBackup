...
interface MerlinBackupInterface
{
     ...
     * @var string MERLIN_MYSQLDUMP_UTILITY     The location on the system for the mysqldump utility
     * @var string MERLIN_MYSQLDUMP_REPOSITORY  The location on the system for storing all backups
